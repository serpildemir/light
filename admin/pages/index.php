                        ...
                        <form role="form" action=""method="POST">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Kullanıcı Adı" name="username" type="text" outofocus required>
                                </div>
                                <div class="form-group">
...
if(@$_POST["submit"]){
    ...
    if($ka == "admin" && $si =="12345"){
        //giriş yapsın
        $_SESSION ["girisKontrol"]= 1;//giriş yapmış anlamına geliyor
        header("Location:anasayfa.php");
        return true;
    }else{
...
if(@$_GET["i"]== "cikis"){
    ...
    echo "<p style='text-align: center; color:red;'> Öncellikle Giriş Yapınız </p>";
}
