...
$ekle = $db->prepare("İNSERT İNTO 'blog'('baslik','alt_baslik','aciklama','aktif') VALUES
...
$ekle->
bindValue(":aktif", $aktif,PDO::PARAM_STR);
if($ekle->execute())
...
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form"action="" method="POST" enctype="mutltipart/form-data">
    ...
    <script src="../admin/js/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
